<x-client-layout>
    ...
    <div class="notice mb-6" x-data="{
        ...
        <div role="alert" class="alert bg-primary text-primary-content py-2">
            ...
            <div class="flex gap-1">
                <a href="{{ $notice->link }}"
                    class="btn btn-sm bg-green-600 dark:bg-secondary text-green-200 dark:text-primary border-green-600 dark:border-primary-content hover:text-green-700"
    ...
    {{-- WA ICON --}}
    <span
        class="fixed bottom-20 sm:bottom-28 right-10 z-[9999] opacity-70 hover:opacity-100 duration-300 tooltip tooltip-left"
