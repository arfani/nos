...
<div x-data="{ show: true }" x-show="show" x-transition:leave.duration.500ms
    x-init="setTimeout(() => show = false, 5000)" class="toast toast-top toast-end mt-20 z-50">
...
<div class="w-full sm:w-11/12 mb-6 mx-auto" x-data>
    ...
    <div class="p-6 bg-base-200 rounded">
        <div x-show="!$store.auction.isCommentTab">
            ...
            <div class="chat {{ auth()->user() && $bid->user->id === auth()->user()->id ? 'chat-end' : 'chat-start' }}">
        ...
        <div x-show="$store.auction.isCommentTab">
            ...
            <div
                ...
                <div class="chat-image avatar">
                    <div class="w-10 rounded-full">
                        <img alt="{{ 'Foto ' . $comment->user->name }}" src="{{ Storage::url($comment->user->img) }}" />
                    </div>
                </div>
                <div class="chat-header">
